...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            fill: ["rgba(0,0,0,0)",im+"dialogo32.png",'0px','0px']
                        },
                        {
                            id: '_05_11',
                            type: 'image',
                            ...
                            opacity: '0.000000',
                            fill: ["rgba(0,0,0,0)",im+"dialogo35.png",'0px','0px']
                        },
                        {
                            id: '_05_08',
                            type: 'image',
                            ...
                            opacity: '0.008130',
                            fill: ["rgba(0,0,0,0)",im+"dialogo34.png",'0px','0px']
                        },
                        {
                            id: '_05_14',
                            type: 'image',
                            ...
                            opacity: '0.000000',
                            fill: ["rgba(0,0,0,0)",im+"dialogo37.png",'0px','0px']
                        },
                        {
                            id: '_05_18',
                            type: 'image',
                            ...
                            opacity: '0.000000',
                            fill: ["rgba(0,0,0,0)",im+"dialogo38.png",'0px','0px']
                        },
                        {
                            id: '_05_05',
                            type: 'image',
                            ...
                            opacity: '0',
                            fill: ["rgba(0,0,0,0)",im+"dialogo33.png",'0px','0px']
                        }
                    ],
                    style: {
                        '${Stage}': {
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("05e_edgeActions.js");
})("EDGE-807819582");
